...
y4 <- df2$Voltage
y5 <- df2$Global_reactive_power

png(filename="plot4.png")

par(mfcol=c(2,2))

plot(y, type="l",xaxt="n",ylab="Global Active Power (kilowatts)")
axis(1,at=1,c("Thu"))
...
plot(y4, type="l",xaxt="n",ylab="Voltage")
axis(1,at=1,c("Thu"))
axis(1,at=1440,c("Fri"))
axis(1,at=2880,c("Sat"))


plot(y5, type="l",xaxt="n",ylab="Global_reactive_power")
axis(1,at=1,c("Thu"))
axis(1,at=1440,c("Fri"))
axis(1,at=2880,c("Sat"))
